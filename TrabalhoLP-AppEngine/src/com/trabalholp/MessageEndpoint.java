 ...
 * (https://console.developers.google.com/project). You'll first have to create
 * a project and enable the Google Cloud Messaging Service for it, as described
 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "trabalholp.com", ownerName = "trabalholp.com", packagePath=""))
// NO AUTHENTICATION; OPEN ENDPOINT!
public class MessageEndpoint {

  /*
   * TODO: Fill this in with the server key that you've obtained from the API
   * Console (https://console.developers.google.com/project). This is required
   * for using Google Cloud Messaging from your AppEngine application even if
   * you are using an App Engine's local development server.
   */
